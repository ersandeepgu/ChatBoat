<?php
namespace Sandeep\Chatboat\Model\Config\Backend;

class ChatboatImage extends \Magento\Config\Model\Config\Backend\Image
{
    /**
     * The tail part of directory path for uploading
     */
    const UPLOAD_DIR = 'chatboatimage/backendimage';
